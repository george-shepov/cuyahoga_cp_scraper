...
RECOMMENDED_FIRST_BATCH: List[Dict[str, Any]] = [
    {
        "title": "What should I expect at my first felony court date in Cuyahoga County?",
        "question": "What should I expect at my first felony court date in Cuyahoga County?",
        "content_type": ContentType.GUIDE,
        "charge_type": None,
        "tags": ["first-court-date", "felony", "what-to-expect"],
    },
    {
        "title": "How much does the assigned judge affect the likely outcome?",
        "question": "How much does the assigned judge affect the likely outcome?",
        "content_type": ContentType.FAQ,
        "charge_type": None,
        "tags": ["judge-patterns", "outcomes", "courtroom-strategy"],
    },
    {
        "title": "When does it make sense to fight the case versus negotiate early?",
        "question": "When does it make sense to fight the case versus negotiate early?",
        "content_type": ContentType.GUIDE,
        "charge_type": None,
        "tags": ["trial", "plea-negotiation", "timing"],
    },
    {
        "title": "What can a defense lawyer realistically change in a case like this?",
        "question": "What can a defense lawyer realistically change in a case like this?",
        "content_type": ContentType.FAQ,
        "charge_type": None,
        "tags": ["defense-strategy", "expectations", "client-education"],
    },
    {
        "title": "How do prosecutors differ in plea posture and trial pressure?",
        "question": "How do prosecutors differ in plea posture and trial pressure?",
        "content_type": ContentType.FAQ,
        "charge_type": None,
        "tags": ["prosecutor-patterns", "plea-negotiation", "trial-pressure"],
    },
    {
        "title": "What does a favorable outcome actually look like in this court?",
        "question": "What does a favorable outcome actually look like in this court?",
        "content_type": ContentType.FAQ,
        "charge_type": None,
        "tags": ["outcomes", "decision-making", "client-education"],
    },
    {
        "title": "How long do criminal cases like this usually take?",
        "question": "How long do criminal cases like this usually take?",
        "content_type": ContentType.FAQ,
        "charge_type": None,
        "tags": ["timeline", "what-to-expect"],
    },
    {
        "title": "What should I do before talking to the prosecutor or appearing in court?",
        "question": "What should I do before talking to the prosecutor or appearing in court?",
        "content_type": ContentType.GUIDE,
        "charge_type": None,
        "tags": ["preparation", "first-appearance", "checklist"],
    },
    {
        "title": "How should I think about hiring a lawyer for this specific judge and prosecutor?",
        "question": "How should I think about hiring a lawyer for this specific judge and prosecutor?",
        "content_type": ContentType.GUIDE,
        "charge_type": None,
        "tags": ["attorney-selection", "judge-patterns", "prosecutor-patterns"],
    },
    {
        "title": "What warning signs suggest a case may get more serious over time?",
        "question": "What warning signs suggest a case may get more serious over time?",
        "content_type": ContentType.FAQ,
        "charge_type": None,
        "tags": ["risk", "case-escalation", "early-action"],
    },
]
...
def build_seed_questions(dataset_summary: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    return [*RECOMMENDED_FIRST_BATCH, *supplemental_questions]
